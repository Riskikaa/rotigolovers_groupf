...
class DataService {
  Future insertRotigolovers(
      ...
      String total_pembelian) async {
    String uri = 'https://io.etter.cloud/v4/insert';

    try {
      final response = await http.post(Uri.parse(uri), body: {
        'token': '67072f0a1be56c51cde09db4',
        'project': 'rotigolovers',
        'collection': 'rotigolovers',
        'appid': appid,
        'nama_menu': nama_menu,
        'quantity': quantity,
        'jenis': jenis,
  ...
  upload(String token, String project, Uint8List uint8list, String string) {}
}
...
Future<String> upload(
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      return res.body; // Return the response body if the upload is successful.
    } else {
